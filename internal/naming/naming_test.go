...
func TestTweetNaming_LogFormat(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			creator:  "吕布(QqiRru)",
			expected: "[吕布(QqiRru)] 比基尼 _1355100264760393735",
		},
		{
			name:     "empty text",
			text:     "",
		...
		},
		{
			...
			tweetID:  456,
			creator:  "user",
			expected: "[user] hello world _456",
		},
		{
			...
			tweetID:  789,
			creator:  "user",
			expected: "[user] hello world _789",
		},
		{
			name:     "text with tab",
			text:     "hello\tworld",
			tweetID:  101,
			creator:  "user",
			expected: "[user] hello\tworld _101",
		},
		{
			name:     "text with URL",
		...
		},
		{
			...
			tweetID:  ^uint64(0),
			creator:  "user",
			expected: "[user] test _18446744073709551615",
		},
		{
			name:     "zero tweetID",
			text:     "test",
		...
		},
		{
			...
			tweetID:  808,
			creator:  "user",
			expected: "[user] line1 line2 line3 _808",
		},
		{
